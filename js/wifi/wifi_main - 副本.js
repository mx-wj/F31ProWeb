...
define([ 'jquery', 'knockout', 'config/config', 'service', 'underscore' ], function ($, ko, config, service, _) {
        ...
        function WifiBasicVM() {
            ...
            config.HAS_MULTI_SSID = info.disable_m_ssid!=="yes";
            config.AP_STATION_SUPPORT = info.wifi_sta_need_display==="yes";
            ...
            self.clickSSIDHandler = function () {
                console.log(111)
